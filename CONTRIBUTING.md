# Contributing to uco-victim

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to uco-victim. 
...
The uco-victim team strives to create a
...
Please use our [Issue Tracker](https://github.com/lmodel/uco-victim/issues/) for reporting problems with the ontology. 
