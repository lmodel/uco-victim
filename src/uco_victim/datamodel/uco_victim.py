...
# Generation date: 2023-03-01T21:49:13
# Schema: uco-victim
#
...
SCHEMA_ROLE = CurieNamespace('schema_role', 'https://w3id.org/lmodel/uco-role/schema/')
...
slots.hasFacet = Slot(uri=CORE.hasFacet, name="hasFacet", curie=CORE.curie('hasFacet'),
                   model_uri=VICTIM.hasFacet, domain=Facet, range=Optional[str])
